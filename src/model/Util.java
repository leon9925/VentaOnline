...
{   
    ...
    public static final String PRODUCT_NAME_TAG = "name";
    public static final String PRODUCT_PAYMENTFORM_TAG = "payment";
    public static final String PRODUCT_MINIMUNT_TAG = "minimunt";
    public static final String PRODUCT_MAXIMUNTX_TAG = "maximuntx";
    public static final String PRODUCT_MAXIMUNV_TAG = "maximunv";
    ...
    public static final String ERROR_CLIENT_RIF_TAG = "Error loading Client from XML - Error in the attribute " + CLIENT_RIF_TAG + " of the XML tag";
    ...
    public static final String ERROR_PRODUCT_NAME_TAG = "Error loading User from XML - Error in the attribute " + PRODUCT_NAME_TAG + " of the XML tag";
    public static final String ERROR_PRODUCT_PAYMENTFORM_TAG = "Error loading User from XML - Error in the attribute " + PRODUCT_PAYMENTFORM_TAG + " of the XML tag";
    public static final String ERROR_PRODUCT_MINIMUNT_TAG= "Error loading User from XML - Error in the attribute " + PRODUCT_MINIMUNT_TAG + " of the XML tag";
    public static final String ERROR_PRODUCT_MAXIMUNTX_TAG= "Error loading User from XML - Error in the attribute " + PRODUCT_MAXIMUNTX_TAG + " of the XML tag";
    public static final String ERROR_PRODUCT_MAXIMUNV_TAG= "Error loading User from XML - Error in the attribute " + PRODUCT_MAXIMUNV_TAG + " of the XML tag";
